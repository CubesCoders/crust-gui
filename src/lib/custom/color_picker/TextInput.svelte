...
<div class="text-input">
	{#if mode === 0}
		<div class="input-container">
			<input value={hex} on:input={updateHex} style="flex: 3" class="border bg-background rounded text-foreground pl-1" />
			<!-- {#if isAlpha}
				<input
					...
					max="1"
					step="0.01"
                    class="border bg-background rounded text-foreground pl-1"
